...
# 3. 준비
# linear = MLPRegressor(hidden_layer_sizes=[10, 2], max_iter=500)  # hidden_layer_sizes 디폴트값 찾아보기
linear = MLPRegressor(activation='relu', hidden_layer_sizes=(100, 2), solver='adam')
